    ...
    <div>
        ...
        <div>
            <div>
                ...
                <ul>
                    <li style="font-size:8"> will be constantly available, or available at all, or</li>
                    <li style="font-size:8"> is true, accurate, complete, current or non-misleading.</li>
                </ul>
            </div>
