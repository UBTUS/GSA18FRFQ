...
* Yes. Management approved to complete project with 6 member agile team in 5 day sprint. We took second sprint approval to amend features.

- [ ] Contract is structured to request frequent deliverables, not multi-month milestones
* Not Applicable. We implemented this project with our full time team members.
...
*A*. Scope of project is clearly defined in sprint backlog.

- What are the milestones? How frequent are they?

*A*. Milestone is to deliver MVP product with user friendly features.
